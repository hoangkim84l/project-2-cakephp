...
<div class="box">
  ...
  <div class="container content">
    ...
    <form method="post" action="{{url('admin/slide/'.$slide->id)}}" enctype="multipart/form-data" class="form-horizontal">
      @method('PATCH')
      @csrf
        ...
        <div id="home" class="tab-pane fade in active">
          <p>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <img src="<?php echo asset("storage/slide/$slide->image_link") ?>" style="max-width: 400px; max-height: 400px; padding-bottom: 20px;">
